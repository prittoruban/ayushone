  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-primary-200/20 dark:bg-primary-400/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
      </div>
