  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-10 w-72 h-72 bg-accent-200/20 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-primary-200/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
      </div>
            ...
            <div className="hidden lg:block animate-fade-in-left">
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl text-secondary-600 mb-8 leading-relaxed">
                  ...
                  book consultations, and experience the power of traditional medicine.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 p-6 bg-gradient-to-r from-primary-50 to-accent-50 rounded-2xl">
                  <div className="text-center">
                    ...
                    <div className="text-sm font-semibold text-secondary-900">For Patients</div>
                    <div className="text-xs text-secondary-600">Find & consult practitioners</div>
                  </div>
                  <div className="text-center">
                    <Stethoscope className="w-10 h-10 text-accent-600 mx-auto mb-3" />
                    <div className="text-sm font-semibold text-secondary-900">For Doctors</div>
                    <div className="text-xs text-secondary-600">Join our network</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-6 pt-8 mt-8 border-t border-secondary-200">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-secondary-600">Data Protected</div>
                  </div>
                  <div className="text-center">
                    <Heart className="w-8 h-8 text-accent-600 mx-auto mb-2" />
                    <div className="text-sm font-medium text-secondary-900">Trusted</div>
                    <div className="text-xs text-secondary-600">4.9/5 Rating</div>
                  </div>
                  <div className="text-center">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 gap-3">
                          <label className={`relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all duration-200 ${
                            ...
                            <div className="flex items-center space-x-3">
                              <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                                role === 'citizen' ? 'bg-primary-100' : 'bg-secondary-100'
                              }`}>
                                <UserCheck className={`w-5 h-5 ${
                                  role === 'citizen' ? 'text-primary-600' : 'text-secondary-400'
                                }`} />
                              </div>
                              <div>
                                <div className="font-medium text-secondary-900">Patient/Citizen</div>
                                <div className="text-sm text-secondary-600">Looking for treatment</div>
                              </div>
                            </div>
                            {role === 'citizen' && (
                          ...
                          <label className={`relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all duration-200 ${
                            ...
                            <div className="flex items-center space-x-3">
                              <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                                role === 'doctor' ? 'bg-primary-100' : 'bg-secondary-100'
                              }`}>
                                <Stethoscope className={`w-5 h-5 ${
                                  role === 'doctor' ? 'text-primary-600' : 'text-secondary-400'
                                }`} />
                              </div>
                              <div>
                                <div className="font-medium text-secondary-900">AYUSH Doctor</div>
                                <div className="text-sm text-secondary-600">Join our network</div>
                              </div>
                            </div>
                            {role === 'doctor' && (
                              <CheckCircle className="absolute right-4 w-6 h-6 text-primary-600" />
