      ...
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
        ...
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-slate-400">Please sign in to view your appointments.</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {message && (
          <div className="mb-6 p-4 rounded-lg bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-300 border border-red-400 dark:border-red-800">
            {message}
          </div>
        )}
        ...
        {appointments.length === 0 ? (
          ...
          <div className="space-y-4">
            {appointments.map((appointment) => (
              <div key={appointment.id} className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
